...
<div class="student-notice">
  ...
  <div class="student-notice-text">This document was generated by the student from the DSSSMS student portal and is not an official transcript. Official transcripts must be issued or verified by Dinsho Secondary School.</div>
...
export function TranscriptPage() {
  ...
  async function handleDownload() {
    ...
    try {
      if (user?.role === 'STUDENT') {
        // Student copy — download from session-scoped endpoint (never uses studentId from state)
        await academicReportsApi.downloadMyTranscriptPdf(transcript.admissionNumber);
      } else {
  ...
  function handlePrint() {
    ...
    const html = buildPrint({
      ...
      yearGroups,
      allSubjectNames,
      isStudentCopy:     user?.role === 'STUDENT',
    });
